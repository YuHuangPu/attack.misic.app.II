...
public class Input extends Element {
	...
	public Input(Element label, String styleClass, String type, String name, String value, String defaultValue) {
		...
		String inputTemp = String.format(html, styleClass, type, name, StringUtil.eliminateNull(value, defaultValue));
		inputTemp = (StringUtil.isNull(label) ? inputTemp : (String.format(label.getHtml(), inputTemp)));
